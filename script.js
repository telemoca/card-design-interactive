...
formulaire.addEventListener("submit", (event) => {
    ...
    if(numbersIn.value.length != numbersIn.maxLength && numbersIn.value !== '') {
...
numbersIn.addEventListener('input', () => {
    ...
    nb==0?numbersOut.innerText = "0000 0000 0000 0000":numbersOut.innerText = newValue
    
    nb==0?document.getElementById('card-numbers-card').style['letter-spacing'] = "2px":document.getElementById('card-numbers-card').style['letter-spacing'] = "2.5px"
